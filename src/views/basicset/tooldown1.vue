  ...
  <div class='app-container' style="margin-top:5px;position:relative;">
      ...
      <el-row class="midcontent">
        <el-col :span="24"  class="contenttitle">
              <span class="spanzi">完整版详细教程</span>
              <span class="fanhuizi"><router-link :to="{path:'/dealer/basicset/tooldown'}">返回系统工具下载</router-link></span>
        </el-col>
       <el-col :span="24"  class="content">
         <div class="conimg"><router-link :to="{path:'/dealer/basicset/tooldown2'}"><img style="width:100px;height:40px" @mouseover="back = backalldj" @mouseout="back = backall" :src="back" alt=""></router-link></div>
         <el-carousel indicator-position="outside" :autoplay='false' height="500px">
            <el-carousel-item v-for="(index,item) in slidelist" :key="item" :label="item+1">
             
              <img :src="index" style="width:820px;height:424px;margin-left:100px" alt="" srcset="">
            </el-carousel-item>
          </el-carousel>
       </el-col>
      </el-row>
...
import backall from '@/assets/images/backall.png'
import backalldj from '@/assets/images/backalldj.png'
  ...
  data() {
    return {
      slidelist: [
        ...
        '../static/images/slide5.png',
        '../static/images/slide6.png',
        '../static/images/slide7.png',
        '../static/images/slide8.png',
        '../static/images/slide9.png',
        '../static/images/slide10.png'
      ],
      download1,
      download2,
      backalldj,
