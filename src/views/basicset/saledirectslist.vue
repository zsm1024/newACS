      ...
      <el-row>
        <el-col :span="18">
          ...
          >
            ...
            <el-breadcrumb-item>销售总监管理</el-breadcrumb-item>
          </el-breadcrumb>
...
export default {
  data() {
    return {
      ...
      lists: [],
      cols: [
        { title: "销售总监", field: "name" },
        { title: "销售总监电话", field: "phone" },
      ...
      rules: {
        name: [{ required: true, message: "请输入销售总监", trigger: "blur" }],
  ...
  methods: {
    ...
    getlists() {
      ...
      getsaledirectslist(para).then(res => {
        if (res.data.success) {
...
.add-sale /deep/ .el-dialog__body {
  padding-bottom: 0px;
}
.add-sale /deep/ .el-dialog__footer {
  padding-bottom: 24px;
}
